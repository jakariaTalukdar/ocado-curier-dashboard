        ...
        <div className='w-full md:w-[420px] bg-[#ffffff33] backdrop-blur-md p-7 rounded-md border border-gray-300 text-black shadow-md flex flex-col gap-y-7'>
          ...
          <div className='flex flex-col gap-y-7'>
            ...
            <div className='flex items-center border-b'>
              ...
              <svg onClick={()=> setPassStatus(!pasStatus)} className={`${pasStatus ? 'block' : 'hidden'}`} xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-eye"><path d="M2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 19.876 0 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-19.876 0"/><circle cx="12" cy="12" r="3"/></svg>
              <svg onClick={()=> setPassStatus(!pasStatus)} className={`${pasStatus ? 'hidden' : 'block'}`} xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-eye-off"><path d="M10.733 5.076a10.744 10.744 0 0 1 11.205 6.575 1 1 0 0 1 0 .696 10.747 10.747 0 0 1-1.444 2.49"/><path d="M14.084 14.158a3 3 0 0 1-4.242-4.242"/><path d="M17.479 17.499a10.75 10.75 0 0 1-15.417-5.151 1 1 0 0 1 0-.696 10.75 10.75 0 0 1 4.446-5.143"/><path d="m2 2 20 20"/></svg>
            </div>
            ...
            <div className='flex items-center justify-center'>
              <button className='px-4 py-1 bg-red-700 hover:bg-red-800 font-semibold transitions text-white rounded-md'>Login</button>
            </div>
            <span className='text-sm text-center'>I don't have an account <Link href="/register" className='text-red-600 font-medium hover:underline'>Register</Link></span>
          </div>
        </div>
      </div>
    </div>
